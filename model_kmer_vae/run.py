...
from kmer_vae_model import KmerVAEModel

results_dir = "model_kmer_vae/results_latest"
...
if __name__ == '__main__':
    ...
    model = KmerVAEModel(train_df, test_df, epochs, batch_size, learning_rate, weight_decay, dropout_rate, latent_dim, motif_embed_dim, beta, lambda_cls, kmer_size, pwm_dir)
    ...
    fig.suptitle('K-Mer VAE Performance', fontsize=16, fontweight='bold')
    ...
    plt.tight_layout()
    fig.savefig(os.path.join(results_dir, "Metrics_KMER_VAE.png"), dpi=300)
    plt.close(fig)
